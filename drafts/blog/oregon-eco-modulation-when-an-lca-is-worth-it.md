---
title: "Oregon's Eco-Modulation Bonuses: When an LCA Is Worth the Cost"
...
source_note: >
  ...
  discussion, repurposed into a general blog post instead: an upcoming
  EPR customer newsletter (Aaron Barranco) will carry a short blurb
  linking here, with its own CTA. Per the agreed direction in that
  thread, this draft features an attributed quote from Planet FWD (who
